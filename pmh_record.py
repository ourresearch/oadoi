...
class PmhRecord(db.Model):
    ...
    def populate(self, endpoint_id, pmh_input_record, metadata_prefix='oai_dc'):
        ...
        if self.pmh_id and self.pmh_id.startswith('oai:alma.44SUR_INST') or self.pmh_id.startswith('oai:alma.44SUR_INST'):
            ...
            for url in good_urls:
                ...
                if normalized_title:
                    ...
                    if (
                            ...
                            and normalized_title not in title_match_limit_exceptions()
                            and "oai:HAL:" not in self.bare_pmh_id
                    ):
                        logger.info(
