...
def load_csv(csv_filename):
    ...
    logger.info(f'backfilling rows in recordthresher.pubmed_raw')
    db.session.execute(text('insert into recordthresher.pubmed_raw (select * from tmp_pubmed_raw) on conflict do nothing'))
