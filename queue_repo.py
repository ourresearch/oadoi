        ...
        if not single_obj_id:
            text_query_pattern = """WITH picked_from_queue AS (
                       ...
                       and (last_harvest_started is null or
                        ...
                        and id in ('citeseerx.ist.psu.edu/oai2', 'europepmc.org/oai.cgi',
                        'export.arxiv.org/oai2', 'www.ncbi.nlm.nih.gov/pmc/oai/oai.cgi', 'www.ncbi.nlm.nih.gov/pmc/oai/oai.cgi2')
