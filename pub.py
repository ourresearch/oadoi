...
class Pub(db.Model):
    ...
    def ask_local_lookup(self):
        ...
        if evidence and not failed_scrape:
            ...
            my_location.not_ol_exception_func = lambda: not (license == 'publisher-specific-oa' and ('elsevier' in self.publisher.lower() or 'sciencedirect.com' in self.resolved_doi_url))
